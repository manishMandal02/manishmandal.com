...
const MyEmail: React.FC<Props> = ({ customAnimation }) => {
  ...
  return (
    <>
      <motion.div
        className='w-[24rem] ms:w-82 relative group flex justify-between items-center mt-16 ms:mt-12 border-2 border-primary dark:border-primary-dark  cursor-pointer rounded-md overflow-hidden border-collapse  shadow-primary  shadow-sm '
